-- Synaptic Database Initialization for Liquibase
-- Creates extensions, tables, indexes, functions, and views for the cognitive memory database.

-- Enable pgvector extension (AlloyDB natively supports this)
...
CREATE TABLE IF NOT EXISTS memories (
    ...
    -- Embedding vector (768 dimensions for nomic-embed-text / text-embedding-004)
...
-- Schema migration tracking (Liquibase will have its own tracking, but keeping this for safety/compatibility)
...
COMMENT ON COLUMN memories.embedding IS '768-dimensional vector from nomic-embed-text / text-embedding-004 model';
